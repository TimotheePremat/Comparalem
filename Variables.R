...
cat2_1 <- readline(prompt="Enter name of 1st data category (2 cat. analysis): ")
cat2_2 <- readline(prompt="Enter name of 2nd data category (2 cat. analysis): ")
...
## The following lines ask (interactively) the user to enter custom name.
file_name <- readline(prompt="Enter prefix for naming files:")
title_element <- readline(prompt="Enter name for titles and legends:")
...
dependent_var <- readline(prompt="Enter the name of your dependent variable (for legends):")
corpus_var <- readline(prompt="Enter the name (and ref, optionnaly) of the corpus you use:")
