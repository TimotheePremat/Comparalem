...
#Indicate variables
var_loc <- readline(prompt="Indicate which variable (col) in the data is to be used for plotting (for NCA, try R_code_suppl_total):")
var_loc_rename <- readline(prompt="Indicate which variable corresponds to this in the shapefiles (for NCA: R_Code):")
var_loc_label <- readline(prompt="Indicate which variable (col) is to be used for labelling regions (for NCA, try regionDees_supp):")
