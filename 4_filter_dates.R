...
standard_date <- readline(prompt="Indicate which variable (col) is the date variable in the data:")
...
filter_date <- readline(prompt="Do you wish to filter out by date? Anwser yes or no:")
